...
public class Msg4Voice extends Msg {
    ...
    public void read(Document document) {
        this.mediaId = this.getElementContent(document, "MediaId");
        this.format = this.getElementContent(document, "Format");
        this.recognition = this.getElementContent(document, "Recognition");
        this.msgId = this.getElementContent(document, "MsgId");
    }
